...
public abstract class MQTT {
    ...
    // Link to explanation of abstract classes uses: https://www.codebyamir.com/blog/when-to-use-an-abstract-class-in-java
    // Link to difference between abstract classes and interfaces: https://www.guru99.com/interface-vs-abstract-class-java.html
    ...
    public void sendMessage(String topic, byte[] payload, MqttQos qos) {
        client.sendMessage(topic, payload, qos);
    }
